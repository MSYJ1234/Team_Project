...
* 1994 : ***GNU Project***에서 ***Linux Kernel***을 채택하고, ***GNU/Linux***로 명명되었습니다. Linux Kernel 그 자체만으로는 시스템을 구성 할 수 없기 때문에, GNU/Linux 에서 기타 프로그램 제작에 큰 기여를 하였습니다. 그리고 이것이 전세계 개발자들이 자유롭게 Linux의 개발에 참여할 수 있는 토대가 마련되어, 결국 1994년 3월에 첫 번째 완성 버전인 Linux Kernel 1.0.0이 공개되었습니다.
