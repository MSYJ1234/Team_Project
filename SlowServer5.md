...
SSH 프로토콜을 사용하려면 주소 앞에 'ssh://계정@주소'처럼 프로토콜 타입을 지정해야 합니다. 계정을 생략하여 현재 로그인된 사용자로 대체할 수도 있습니다.
...
깃은 원격 저장소(서버)를 관리하는 데 **remote 명령어**를 사용합니다. remote 명령어를 사용하면 현재 연결된 원격 저장소 목록을 확인할 수 있습니다.   
